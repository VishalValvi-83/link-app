...
const QRHelpPage = () => {
  return (
    <section className="bg-white dark:bg-gray-900 min-h-screen py-12 px-6 lg:px-24">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-400">
            Go to the <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">/create-link</code> page, paste your long URL, and optionally enter a custom short name.
          </p>
        </div>
        ...
        <div className="mt-10">
          <a href="/create-link" className="inline-block px-6 py-3 bg-primary-700 text-white font-semibold rounded hover:bg-primary-800">

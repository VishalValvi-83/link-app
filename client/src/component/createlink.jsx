                    ...
                    <div className="flex flex-wrap justify-center -m-4">
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border border-gray-200 p-6 rounded-lg">
                                ...
                                <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Step 1: Enter Your Long URL</h2>
                        ...
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border border-gray-200 p-6 rounded-lg">
                                ...
                                <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Step 2: Customize Your Link</h2>
                        ...
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border border-gray-200 p-6 rounded-lg">
                                ...
                                <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Step 3: Generate Your Short Link</h2>
                        ...
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border border-gray-200 p-6 rounded-lg">
                                ...
                                <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Step 4: Track Link Performance</h2>
                        ...
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border border-gray-200 p-6 rounded-lg">
                                ...
                                <h2 className="text-lg text-gray-900 font-medium title-font mb-2">Step 4: Share Your Link</h2>

            ...
            <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-sm text-gray-500 dark:text-gray-400">
                        Manage, shorten, and track your links with ease. Join our growing community today!
                    </p>

                    <a
                        href="/dashboard"
                        className="mt-8 inline-block rounded-full border border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:ring-3 focus:outline-none"
                    >
                        Get Started
                    </a>
                </div>
